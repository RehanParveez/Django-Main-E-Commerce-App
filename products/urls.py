...
urlpatterns = [
    ...
    path('productdetail/<int:pk>', ProductDetailView.as_view(), name='product_detail'), # for now detail url is without any pk or slug value because i am yet to fix all the template files to dynamic bcz they are static for now according to django templating requirement
