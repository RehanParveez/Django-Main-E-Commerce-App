...
from cart.views import get_cart, CartDetailView, CartAddView, CartItemUpdateView, CartItemDeleteView, CheckoutInfoView
...
urlpatterns = [
    ...
    path('checkout/info/', CheckoutInfoView.as_view(), name='checkout_info'),
]
